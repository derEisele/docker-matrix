...
   ` docker run -v /opt/synapse:/data --rm -e SERVER_NAME=example.com -e REPORT_STATS=no dereisele/docker-matrix:v0.26.0 generate`
...
`docker run --name=matrix -d --restart=always -p 8448:8448 -p 8008:8008 -p 3478:3478 -p 3478:3478/udp -p 5349:5349/udp -p 5349:5349 -p 49152-49300:49152-49300/udp -p 49152-49300:49152-49300 -v /opt/synapse:/data dereisele/docker-matrix:v0.26.0 start`
